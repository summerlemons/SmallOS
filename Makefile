...
all: ${TARGET}/boot.o ${TARGET}/setup.o
	...
	dd if=${TARGET}/setup.o of=${TARGET}/${DISK_NAME} bs=512 count=1 seek=1 conv=notrunc
	dd if=${TARGET}/setup.o of=${TARGET}/${DISK_NAME} bs=512 count=1 seek=2 conv=notrunc
